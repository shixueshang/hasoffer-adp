...
public class Video {
     ...
     * Specification Table 6.6 Video Linearity  for a
     ...
     * Response Protocols for a list of
     * possible values.
     *
     * Required.
     */
     ...
     * Attributes. If blank assume all types are
     * allowed.
     */
    ...
    /**
     * Ad Position (see specification table 6.5 )
     */
     ...
     * Table 6.4 API Frameworks. If an API is not
     ...
     * 6.17 VAST Companion Types for a list of possible values.
     */
