package hasoffer.adp.rtb.adx.request;
...
public class Banner {
    ...
    /**
     * Ad Position. Use Specification Table 6.5
     */
    private Integer pos = null;

    /**
     * Blocked creative types. See Specification Table 6.2 Banner Ad Types If
     ...
     * Attributes. If blank assume all types are allowed
     */
     ...
     * Expandable Direction for possible values.
     */
    private Integer[] expdir = null;

    /**
     * List of supported API frameworks for this banner. (See Specification
     * Table 6.4 API Frameworks. If an API is not explicitly listed it is
