package hasoffer.adp.base.utils.mail;
...
public class SimpleMailSender {
    public static void main(String[] args) {
        ...
        mailInfo.setUserName("lihongde@hasoffer.com");
        mailInfo.setPassword("liHONGde1990");//您的邮箱密码
        mailInfo.setFromAddress("lihongde@hasoffer.com");
        mailInfo.setToAddress("460847871@qq.com");
