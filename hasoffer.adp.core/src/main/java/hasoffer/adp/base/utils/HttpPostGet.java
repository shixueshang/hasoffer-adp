...
public class HttpPostGet {
    ...
    private static final int CONNT_IMEOUT = 15000;
    private static final int READT_IMEOUT = 15000;
    /**
    ...
    public String sendGet(String url) throws Exception {
        return sendGet(url, CONNT_IMEOUT, READT_IMEOUT);
    }
     ...
     *
     * @param targetURL The URL to transmit to.
    ...
    public String sendPost(String targetURL, String data) throws Exception {
        return sendPost(targetURL, data, CONNT_IMEOUT, READT_IMEOUT);
    }
     ...
     * @param data      byte[] data. The payload bytes.
     ...
     *
     * @param targetURL   String. The URL to transmit to.
     * @param data        byte[]. The payload bytes.
     * @param connTimeout int. The connection timeout in ms
     * @param readTimeout int. The read timeout in ms.
     * @return byte[]. The contents of the POST return.
     * @throws Exception on network errors.
     */
     ...
     *
     * @param targetURL   String. The URL to transmit to.
     * @param data        String. The payload String.
     * @param connTimeout int. The connection timeout in ms
     * @param readTimeout int. The read timeout in ms.
     * @return String. The contents of the POST return.
     * @throws Exception on network errors.
